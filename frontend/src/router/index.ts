...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/:student/resources', name: 'resources', component: () => import('@/views/ResourcesView.vue') },
    { path: '/:student/calendar', name: 'calendar', component: () => import('@/views/CalendarView.vue') },
    { path: '/:student/checklist', name: 'checklist', component: () => import('@/views/ChecklistView.vue') },
