...
DEFAULT_TAGGING_UPDATE_INTERVAL: Final = 3600
DEFAULT_AGENDA_DIGEST_INTERVAL: Final = 1800

# Agenda (calendar + checklist) defaults
DEFAULT_AGENDA_BACKFILL_DAYS: Final = 90
DEFAULT_AGENDA_PAST_WINDOW_DAYS: Final = 14
DEFAULT_AGENDA_FUTURE_WINDOW_DAYS: Final = 90
DEFAULT_AGENDA_REMINDER_HOUR: Final = 18
DEFAULT_AGENDA_TASK_LOOKAHEAD_DAYS: Final = 2
